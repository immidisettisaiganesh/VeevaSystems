...
public class EnhanceReportGenerator implements ITestListener {
    ...
    public void onStart(ITestContext context) {
        ...
        String reportPath = System.getProperty("user.dir") + "/reports/AutomationReport_" 
                            + getTimeStamp() + ".html";
